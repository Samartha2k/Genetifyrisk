...
### Background Design (December 2024)
**Optimized Chromosome Background:**
- Replaced complex multi-element chromosome structures with simplified 2-chromosome design
- **Performance improvements:** Reduced DOM elements from ~70 to ~15 (70% reduction)
- Simplified gradients from 10+ color stops to 3 stops per element
- Reduced box-shadows from 5 per element to 1 per element
- Removed DNA helix animations, telomeres, and sub-bands for better performance
- Added GPU acceleration with `will-change: transform`
- Slowed animation speeds (35-40s) to reduce CPU usage
- **Chromosome 1:** Purple→Blue gradient (150px × 700px) with 4 banding patterns
- **Chromosome 2:** Pink→Orange gradient (130px × 650px) with 3 banding patterns
- Both chromosomes feature simplified float animations and glowing centromeres
